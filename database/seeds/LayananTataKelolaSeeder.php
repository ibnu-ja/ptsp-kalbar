        ...
        DB::table('layanans')->insert([
            ...
            <ol>
              <li>FKUB mengajukan proposal yang memuat :
                <ul>
                  <li>Jumlah / nilai uang bantuan</li>
                  <li>Nomor Rekening a.n FKUB</li>
                </ul>
              </li>
              <li>SK Penetapan Bantuan
                <ul>
                  <li>Perjanjian Kerjasama (PK)</li>
                  <li>Rancangan BIaya Anggaran</li>
                  <li>Surat Pernyataan Pertang Jawaban Mutlah (SPTJM)</li>
                  <li>Kwitansi Penerimaan Bantuan</li>
                </ul>
              </li>
            </ol>",
            'created_at' => Carbon::now(),
