...
(function (e, i) {
        ...
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            var s = {
                ...
                tpl: {
                    ...
                    message: '<div class="card-text file-upload-message"><i class="v-icon mdi  mdi-cloud"></i><p>{{ default }}</p></div>',
                    ...
                    clearButton: '<button type="button" class="btn btn-sm btn-danger">{{ remove }}<i class="v-icon mdi mdi-delete"></i></button>',
    ...
    return i.prototype.onChange = function () {
        ...
        } else e("<i />").attr("class", "v-icon inside mdi mdi-file").appendTo(s), e('<span class="file-upload-extension" />').html(this.getFileType()).appendTo(s);
        this.preview.fadeIn()
